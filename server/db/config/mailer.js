...
const mailer = {
    ...
    sendMail : (userName, userEmail, token)=>{
        ...
        let message ={ 
            ...
            subject: "Welcome!",
            text: `Hello ${userName}! You've been invited to join con-do, the ultimate conference app! Go to http://con-do.herokuapp.com/verify/${token} to get connnected your conference. 
